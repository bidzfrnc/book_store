...
const EditBook = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                ...
                setAuthor(response.data.selectedBook.author);
                setPublishYear(response.data.selectedBook.publishYear);
                setLoading(false);
            }).catch((error) => {
                console.log(error);
                setLoading(false);
    ...
    const handleEditBoook = () => {
        ...
        setLoading(true);
        axios
            .patch(`http://localhost:3000/book/${id}`, data)
            .then(() => {
                setLoading(false);
    ...
    return (
        <div className='p-4'>
            ...
            <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600] p-4 mx-auto'>
                ...
                <button className='p-2 bg-sky-300 m-8' onClick={handleEditBoook}>Save Change</button>
            </div>
        </div>
    )
}
